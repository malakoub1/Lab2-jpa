...
public class Main {
    ...
    private static void testCrudUtilisateur(UtilisateurService service) {
        ...
        Utilisateur u1 = new Utilisateur("Dupont", "Malak", "malak.dupont@example.com");
        u1.setDateNaissance(LocalDate.of(1995, 3, 16));
        u1.setTelephone("+33612345677");

        Utilisateur u2 = new Utilisateur("youssef", "mehdi", "mehdi.youssef@example.com");
        u2.setDateNaissance(LocalDate.of(1999, 12, 22));
        ...
        Optional<Utilisateur> utilisateurParEmail = service.findByEmail("mehdi.youssef@example.com");
        utilisateurParEmail.ifPresent(System.out::println);

        // Mise à jour
        System.out.println("\nMise à jour d'un utilisateur :");
        utilisateurOpt.ifPresent(utilisateur -> {
            utilisateur.setTelephone("+33612345677");
